 ...
 */
export declare function useSignAndExecuteTransactionBlock({ mutationKey, executeFromWallet, ...mutationOptions }?: UseSignAndExecuteTransactionBlockMutationOptions): import("@tanstack/react-query").UseMutationResult<import("@mysten/sui.js/dist/cjs/client/index.js").SuiTransactionBlockResponse, Error | WalletNotConnectedError | WalletNoAccountSelectedError | WalletFeatureNotSupportedError, UseSignAndExecuteTransactionBlockArgs, unknown>;
export {};
